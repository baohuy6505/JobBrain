  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
      ...
      {/* <div className="w-full bg-gray-100 rounded-full h-2.5 mb-8">
        <div className="bg-purple-600 h-2.5 rounded-full" style={{ width: `${rate}%` }}></div>
      </div> */}

      {/* 2 Nút hành động */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <button className="flex items-center justify-center gap-2 py-3 px-4 border border-purple-100 text-purple-600 bg-purple-50/30 rounded-xl hover:bg-purple-50 transition-colors font-medium text-sm">
