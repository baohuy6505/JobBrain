...
import { HiOutlineMailOpen, HiOutlineUsers, HiOutlineLightBulb, HiOutlineUser, HiOutlineLockClosed, HiOutlineBell, HiOutlineLogout } from "react-icons/hi";
    ...
    <>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        <div className="flex justify-between items-center mb-6">
          ...
          <span className="bg-red-100 text-red-600 text-xs font-bold px-2 py-0.5 rounded-full">3 MỚI</span>
        </div>
        
        <div className="space-y-6">
          <div className="flex gap-4">
            <div className="mt-1"><HiOutlineMailOpen className="text-blue-500 text-xl" /></div>
            <div>
              <p className="text-sm font-semibold text-gray-900">TechVina mời bạn phỏng vấn</p>
              <p className="text-xs text-gray-500 mt-1">2 giờ trước</p>
            </div>
          </div>
          <div className="flex gap-4">
            <div className="mt-1"><HiOutlineUsers className="text-purple-500 text-xl" /></div>
            <div>
              <p className="text-sm font-semibold text-gray-900">5 người xem hồ sơ của bạn</p>
              <p className="text-xs text-gray-500 mt-1">Hôm qua</p>
            </div>
          </div>
          <div className="flex gap-4">
            <div className="mt-1"><HiOutlineLightBulb className="text-orange-500 text-xl" /></div>
            <div>
              <p className="text-sm font-semibold text-gray-900">Gợi ý việc làm mới phù hợp</p>
      ...
      {/* Box Support */}
      <div className="bg-[#0b3b9b] rounded-2xl shadow-lg p-6 text-white relative overflow-hidden">
