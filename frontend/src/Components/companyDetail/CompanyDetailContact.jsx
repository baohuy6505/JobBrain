...
const CompanyContact = ({ companyName }) => (
  <div className="bg-[#6344ff] rounded-[2.5rem] p-8 text-white shadow-2xl shadow-indigo-200 sticky top-24">
    ...
    />
    <button className="w-full bg-white text-[#6344ff] py-4 rounded-2xl font-black shadow-lg hover:shadow-white/20 active:scale-95 transition-all">
      ĐĂNG KÝ NGAY
    </button>
  </div>
);
