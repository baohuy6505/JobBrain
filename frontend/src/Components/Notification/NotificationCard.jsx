...
// Nhận thêm prop "onRead" từ Component cha
  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-3 sm:px-4 md:px-0">
      <div
        ...
        className="flex flex-col sm:flex-row sm:items-start gap-3 sm:gap-4 p-4 sm:p-5 md:p-6 rounded-lg sm:rounded-2xl border border-gray-100 bg-white shadow-sm hover:shadow-md transition-all duration-200 mb-3 sm:mb-4 group cursor-pointer active:shadow-sm sm:active:shadow-lg"
      >
        {/* Icon Box */}
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start sm:items-center gap-2 mb-2 sm:mb-1">
            ...
            {/* Chấm tròn báo chưa đọc: Chỉ hiện khi data.unread là true */}
            {data.unread && (
